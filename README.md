...
|---|---|---|---|
| AIDA-Evaluation Docker | Tool for applying the entire evaluation pipeline to task1 (or up to the pre-pooling steps to task2 and task3) submissions | tools/aida-evaluation | FEATURE-b50001 |
