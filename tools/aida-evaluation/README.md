...
* [How to apply the docker on a test run?](#how_to_apply_the_docker_on_a_test_run)
* [How to apply the docker on your run?](#how_to_apply_the_docker_on_your_run)
* [What should be in the input directory?](#what_should_be_in_the_input_directory)
* [What is contained in the output directory?](#what_is_contained_in_the_output_directory)
* [What is contained in the logs directory?](#what_is_contained_in_the_logs_directory)
...
2. Make change to the first line (as shown below) of './docker/Makefile' in order to update the value of $(ROOT)to reflect your system directory where the code form the [AIDA evaluation repository](https://github.com/shahraj81/aida) is placed:
...
| logs                | The directory containing log files. (See the [section on logs](#what_is_contained_in_the_logs_directory) for more details).
