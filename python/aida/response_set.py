...
attributes = {
    ...
    'date': {
        ...
        'name': 'date',
        'tasks': ['task1', 'task3'],
        'schemas': ['AIDA_PHASE2_TASK1_TM_RESPONSE', 'AIDA_PHASE3_TASK3_CT_RESPONSE', 'AIDA_PHASE3_TASK3_TM_RESPONSE'],
    ...
    'document_id': {
        ...
        'schemas': ['AIDA_PHASE2_TASK1_AM_RESPONSE', 'AIDA_PHASE3_TASK1_AM_RESPONSE', 'AIDA_PHASE2_TASK1_CM_RESPONSE', 'AIDA_PHASE3_TASK1_CM_RESPONSE', 'AIDA_PHASE2_TASK1_TM_RESPONSE', 'AIDA_PHASE3_TASK2_ZH_RESPONSE', 'AIDA_PHASE2_TASK3_GR_RESPONSE', 'AIDA_PHASE3_TASK3_GR_RESPONSE', 'AIDA_PHASE3_TASK3_OC_RESPONSE'],
    ...
    'subject_cluster': {
        ...
        'schemas': ['AIDA_PHASE2_TASK1_AM_RESPONSE', 'AIDA_PHASE3_TASK1_AM_RESPONSE', 'AIDA_PHASE2_TASK1_TM_RESPONSE'],
        'tasks': ['task1'],
        'validate': 'validate_entries_in_cluster',
        'years': [2020],
        },
    'subject_cluster_id': {
        ...
        'schemas': ['AIDA_PHASE2_TASK1_AM_RESPONSE', 'AIDA_PHASE3_TASK1_AM_RESPONSE', 'AIDA_PHASE2_TASK1_TM_RESPONSE', 'AIDA_PHASE3_TASK3_CT_RESPONSE', 'AIDA_PHASE3_TASK3_GR_RESPONSE', 'AIDA_PHASE3_TASK3_TM_RESPONSE'],
        'tasks': ['task1', 'task3'],
        'years': [2020, 2021],
        },
...
schemas = {
    ...
    'AIDA_PHASE3_TASK3_GR_RESPONSE': {
        ...
        'year': 2021,
        'task': 'task3',
        'header': ['?docid', '?edge_type', '?is_assertion_negated', '?object_cluster', '?objectmo',
                   '?objectmo_metatype', '?is_objectmo_negated', '?oinf_j_span', '?object_type', 
                   '?subject_cluster', '?subjectmo', '?subjectmo_metatype', '?is_subjectmo_negated',
                   '?sinf_j_span', '?subject_type', '?ej_span', '?objectc_handle', '?edge_cj_cv',
                   '?oinf_j_cv', '?obcm_cv', '?sinf_j_cv', '?sbcm_cv'],
        'columns': [
            'document_id',
            'predicate',
            'is_assertion_negated',
