"""
AIDA class for Argument Extraction evaluation metric scorer V3A1.
"""
...
class ArgumentMetricScorerV3A1(ArgumentMetricScorerV3A):
    """
    AIDA class for Argument Metric scorer V3A1.
    
    V3A1 refers to the variant where TRF triples from all evaluable system argument assertions are compared against TRF triples from all gold argument assertions
