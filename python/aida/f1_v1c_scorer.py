"""
AIDA class for Task3 F1 scorer (Variant 1C).

V1C refers to the variant where:
  - all the submitted claims are considered for scoring regardless of the pooling depth.
  - required fields include: claimTemplate, xVariable
"""
...
class F1ScorerV1C(F1ScorerV1):
    """
    AIDA class for Task3 F1 scorer V1C.
