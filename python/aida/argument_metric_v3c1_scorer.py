"""
AIDA class for Argument Extraction evaluation metric scorer V3C1.
"""
...
class ArgumentMetricScorerV3C1(ArgumentMetricScorerV3C):
    """
    AIDA class for Argument Metric scorer V3C1.
        
    V3C1 refers to the variant where TRF triples from evaluable system argument assertions that are not negated are compared against TRF triples from gold argument assertions that are not negated
